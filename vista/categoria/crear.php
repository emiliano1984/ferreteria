...
<nav class="navbar navbar-dark bg-dark px-4">
    ...
    <div>
        <a href="index.php?controller=producto&action=listar" class="btn btn-outline-light btn-sm me-2">Productos</a>
        <a href="index.php?controller=categoria&action=listar" class="btn btn-outline-light btn-sm">Categorías</a>
    </div>
</nav>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="index.php?controller=categoria&action=crear" method="POST">
                        <div class="mb-3">
                            <label class="form-label">Nombre Categoría</label>
                            <input type="text" name="nombre_categoria" class="form-control" required>
                        </div>
                        <div class="d-flex justify-content-between">
                            <a href="index.php?controller=categoria&action=listar" class="btn btn-secondary">
                                Volver
                            </a>
